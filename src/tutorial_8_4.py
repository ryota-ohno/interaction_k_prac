...
def listen(args):
    ...
    isAvailable = len_queue < num_nodes ##計算ファイルが完成した時だけループから抜け出せる
    ...
    df_init_params_done = filter_df(df_init_params,{'status':'Done'})##getparamsdictでinit_params_dict.csvにdoneを書き込める
